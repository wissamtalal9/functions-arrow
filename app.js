...
const theOldWay = function (course) {
  return `I am currently in this${course}`;
};
...
const oneLiner = course => `I cam currently in this ${course}`;
...
//this keyword is bound to different values based on the context in which the function is called. Whereas arrow functions use the value of this in their lexical scope.
